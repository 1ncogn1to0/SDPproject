...
class NotificationService {
    constructor() {
        ...
        this.subscribers = [];
        NotificationService.instance = this;  // Save instance
    }
...
class RecipeManager {
    constructor() {
        ...
        this.recipes = [];
        this.notificationService = NotificationService.getInstance(); // Use Singleton instance
        this.sortStrategy = this.getSortStrategy('name'); // Default sort strategy
        RecipeManager.instance = this;  // Save instance
    }
    ...
    getSortStrategy(strategy) {
        ...
        return new NameSortStrategy(); // Default to name sort
    }
...
const RecipeList = defineComponent({
    data() {
        return {
            recipeManager: RecipeManager.getInstance(), // Get Singleton instance
            newRecipeName: '',
